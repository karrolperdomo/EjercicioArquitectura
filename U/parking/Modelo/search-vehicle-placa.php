...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Buscar por Placa</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="searchdata" name="searchdata" class="form-control"  required="required" placeholder="Placa vehiculo" autofocus="autofocus" ></div>
                                    </div>
...
<?php
    $ret=mysqli_query($con,"select *from  vehiculo where placa like '$sdata%'");
        ...
        <tr>
          ...
          <td>
            <?php
              if ($row['Estado'] == 'Out'){
            ?>
                <a href="view-outgoingvehicle-detail.php?viewid=<?php echo $row['ID'];?>">Registrar Salida</a></td>
            <?php
              } else {
            ?>
                <a href="view-incomingvehicle-detail.php?viewid=<?php echo $row['ID'];?>">Registrar Entrada</a></td> 
            <?
              }
            ?>
