...
{
$adminid=$_SESSION['parking'];
$cpassword=md5($_POST['currentpassword']);
$newpassword=md5($_POST['newpassword']);
$query=mysqli_query($con,"select ID from persona where ID='$adminid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update persona set password='$newpassword' where ID='$adminid'");
...
{
alert('La nueva contraseña no puede ser la misma que la anterior compae');
