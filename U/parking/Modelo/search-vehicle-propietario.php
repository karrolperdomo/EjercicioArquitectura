...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Buscar por Propietario</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="searchdata" name="searchdata" class="form-control"  required="required" placeholder="Documento del propietario" autofocus="autofocus" ></div>
                                    </div>
...
<?php
    $ret=mysqli_query($con,"select *from  vehiculo where numero_identificacion   like '$sdata%'");
