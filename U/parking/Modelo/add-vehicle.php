                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Ingresar vehículo</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    echo $msg;
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Marca Vehiculo</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="marca" name="marca" class="form-control" placeholder="Marca del vehículo" required="true"></div>
                                    </div>
                                 
                                     <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="text-input" class=" form-control-label">Placa</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="placa" name="placa" class="form-control" placeholder="Número de registro" required="true">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Numero Identificacion Propietario</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="identificacion_propieta" name="identificacion_propieta" class="form-control" placeholder="Numero Identificacion Propietario" required="true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre del propietario</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nombre_propieta" name="nombre_propieta" class="form-control" placeholder="Nombre del propietario" required="true"></div>
                                    </div>
                                     <div class="row form-group">
                                    ...
                                    <p style="text-align: center;">
                                        <button type="submit" class="btn btn-primary btn-sm" name="submit" >Añadir</button>
                                    </p>
                                </form>
                            </div>
