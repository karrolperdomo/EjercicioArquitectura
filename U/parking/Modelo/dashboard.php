...
<head>
    ...
    <title>Tablero de mandos Admin</title>
...
//todays Vehicle Entries
 $query=mysqli_query($con,"select ID from vehiculo where date(HoraEntrada)=CURDATE();");
...
//Yesterdays Vehicle Entrie
 $query1=mysqli_query($con,"select ID from vehiculo where date(HoraEntrada)=CURDATE()-1;");
...
//Last Sevendays Vehicle Entries
 $query2=mysqli_query($con,"select ID from vehiculo where date(HoraEntrada)>=(DATE(NOW()) - INTERVAL 7 DAY);");
...
//Total Vehicle Entries
 $query3=mysqli_query($con,"select ID from vehiculo");
