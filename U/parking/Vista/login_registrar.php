...
if(isset($_POST["btnregistrarx"])) {
	...
	$tipo_de_documento = $_POST["txttipo_documento"];
	...
	if ($nr == 0) {
		...
		$queryregistrar = "INSERT INTO persona(nombre,apellido,tipo_Documento,documento,Direccion,correo,celular,usuario,password)
			values ('$nombre','$apellido','$tipo_de_documento','$documento','$direccion', '$email','$celular','$usuario','$pass_fuerte')";
